...
function Footer() {
  ...
  let AmList = {
    en: [
      "http://ipercash.fr/politiques/aml_en.pdf",
      "http://ipercash.fr/politiques/policy_en.pdf",
      "http://ipercash.fr/politiques/terms_en.pdf",
    ],
    fr: [
      "http://ipercash.fr/politiques/aml_fr.pdf",
      "http://ipercash.fr/politiques/policy_fr.pdf",
      "http://ipercash.fr/politiques/terms_fr.pdf",
    ],
  };
        ...
        <div className="footer-content pl-5 pr-4 md:pl-0 md:pr-0 md:pb-5 flex flex-col w-full md:rounded-t-3xl  text-leight md:flex-row md:justify-around  ">
          <div className=" md:w-5/12  text-left md:px-10 md:py-5 ">
            ...
            <p className=" md:mt-2">
              ...
              générale et pour enfants. - Polar Editions pour les thrillers et
              le roman noir. - Le Crabe Enchanté pour la poésie et opinions. -
              La Bibliothèque Africaine pour le Théâtre.
            </p>
            <br />
          </div>
          ...
          <div className="md:w-2/12 relative mt-4 md:mt-0 md:px-5 md:pt-16">
            <b>Suivez-nous</b>
            <div className="flex">
              <div className="w-24 md:w-10 flex md:flex-col my-3 md:my-0">
                <a
              ...
              <div className=" w-24 md:w-10 flex md:flex-col mx-3 my-3 md:my-0">
                <a href="#">
            ...
            <ul
              onClick={handleTop}
              className=" absolute flex justify-center bg-orange-400 bottom-3 right-3  cursor-pointer lg:right-10 text-white w-10 h-10 rounded-md text-3xl "
            >
              <UilArrowUp size="45" />
            </ul>
          </div>
