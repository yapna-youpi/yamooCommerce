            ...
            <div className="form mb-5 md:mb-0">
                <form action="post">
                    <div className="form-group bg-white flex items-center py-3 pl-1 md:pl-4   shadow-dark-400/40">
                        ...
                        <button type='submit' className='w-4/12 text-sm ml-3 flex items-center font-semibold hover:text-marron hover:duration-500'><i className='mx-2'><UilTelegramAlt/> </i> S'INSCRIRE</button>
                    </div>
                </form>
