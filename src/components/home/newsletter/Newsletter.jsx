    ...
    <div className='newsletter  sm:h-20 md:h-96 flex justify-center items-center md:mt-10 relative'>
        <div className="newsletter-content text-maron ">
            ...
            <div className="newsletter-text">
                <h2 className='text-xl md:text-3xl font-bold my-5 py-3 text-center'>
            ...
            <div className="form mb-5 md:mb-0">
                <form action="post">
                    <div className="form-group bg-white flex items-center py-3 pl-1 md:pl-4   shadow-dark-400/40">
                        ...
                        <button type='submit' className='w-4/12 text-xs ml-0 flex items-center font-semibold hover:text-darkorange hover:duration-500'><i className='mx-2'><UilTelegramAlt/> </i> S'INSCRIRE</button>
                    </div>
                </form>
