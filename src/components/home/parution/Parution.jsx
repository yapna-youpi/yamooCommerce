  ...
  return (
    < div className='my-16'>
      ...
      <div className="flex flex-wrap md:flex-row w-11/12 mx-auto justify-around">
        <Card data={LivreParu[0]} imag={tof1} value={5} hauteur="md:h-64"  url="https://www.amazon.fr/LULA-aime-livres-Boudjeka-KAMTO-ebook/dp/B0CFB452MP/ref=mp_s_a_1_1?crid=3GBS56R5YQAT3&keywords=lula+aime+les+livres&qid=1692008040&sprefix=%2Caps%2C215&sr=8-1" />
        <Card data={LivreParu[1]} imag={tof2} value={4} hauteur="h-96 md:h-64" url="https://amzn.eu/d/5iLlP6Z" />
        <Card target="_blank" data={LivreParu[2]} imag={tof3} value={4}  hauteur="h-96 md:h-64" url="https://www.amazon.fr/Lombre-dun-doute-Boudjeka-KAMTO/dp/9956515035/ref=mp_s_a_1_1?keywords=Boudjeka+KAMTO&qid=1691393857&sr=8-1" />
        <Card data={LivreParu[0]} imag={tof1} value={5} hauteur="md:h-64" url="https://www.amazon.fr/LULA-aime-livres-Boudjeka-KAMTO-ebook/dp/B0CFB452MP/ref=mp_s_a_1_1?crid=3GBS56R5YQAT3&keywords=lula+aime+les+livres&qid=1692008040&sprefix=%2Caps%2C215&sr=8-1" />
