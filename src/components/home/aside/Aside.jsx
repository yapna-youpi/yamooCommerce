  ...
  return (
    <section class="relative py-16 bg-blueGray-50">
      <Modals open={open} onCloseModal={handleClose} center>
        <img
          alt="..."
          class="max-w-9/12 max-h-96 md:max-h-full rounded-lg shadow-lg"
          src={image}
        />
      ...
      <div class="items-center flex flex-wrap">
        <div class="w-full flex justify-center md:w-4/12 ml-auto mr-auto px-4">
          ...
          onClick={()=>setOpen(true)}
            alt="..."
            class="max-w-9/12 max-h-96 md:max-h-full rounded-lg shadow-lg cursor-pointer"
            src={image}
          />
        </div>
            ...
            <ul class="list-none mt-6">
              <li class="py-2">
                <div class="flex items-center">
                  <div>
                    <span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full bg-darkorange mr-3">
