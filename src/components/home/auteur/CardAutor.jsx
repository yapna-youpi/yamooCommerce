  ...
  return (
    <div class="w-full bg-gray-900 rounded-lg sahdow-lg overflow-hidden flex flex-col md:flex-row">
      ...
      <div class="w-full md:w-3/5 text-left p-6 md:p-4 space-y-2">
        <p class="text-xl text-white font-bold">{author.name}</p>
        <p class="text-base text-gray-400 font-normal">{author.poste}</p>
        ...
        <div class="flex justify-start space-x-2">
          ...
          <a href="#" target='_blank' class="text-gray-500 hover:text-gray-600">
            <svg
              class="w-6 h-6"
              aria-hidden="true"
              fill="currentColor"
