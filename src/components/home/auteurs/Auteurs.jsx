...
function Auteurs() {
  ...
  return (
    <>
      ...
      <p className='py-5 px-4 md:px-0 md:pl-14 md:ml-1 font-semibold'>Nos auteurs vous renseignent et vous offrent le meilleur de la litterature africaine.</p>
      <div className="flex flex-wrap md:flex-row w-11/12 mx-auto justify-around">
        <Card data={data} imag={tof1} value={1} />
